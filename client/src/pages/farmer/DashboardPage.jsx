...
const DashboardPage = () => {
  ...
  const totalRevenue = ordersLoading || !farmerOrders
    ? 0
    : farmerOrders
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="glass p-6 rounded-xl">
          ...
          <p className="text-3xl font-bold">{farmerProducts ? farmerProducts.length : 0}</p>
          <Link
            to="/farmer/products"
            ...
            <table className="w-full">
              ...
              <tbody>
                {farmerOrders.slice(0, 5).map((order) => (
                  <tr key={order.id || order._id} className="border-b border-gray-200">
                    <td className="py-3">
                      <Link
      ...
      <div className="glass p-6 rounded-xl">
        ...
        {farmerProducts && farmerProducts.filter((product) => product.quantityAvailable < 10)
          .length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
              ...
              <tbody>
                {farmerProducts
                  ...
                  .slice(0, 5)
                  .map((product) => (
                    <tr key={product.id || product._id} className="border-b border-gray-200">
                      <td className="py-3">
                      ...
                      <td className="text-right py-3">
                        <Link
                          to={`/farmer/products/edit/${product.id || product._id}`}
                          className="text-green-500 hover:text-green-700"
                        >
                          Update Stock
                        </Link>
