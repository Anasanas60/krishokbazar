    ...
    <div>
      ...
      <section className="section section--soft-green">
        <div className="container mx-auto px-4">
          <h2 className="section-heading text-center">Why Choose KrishokBazar?</h2>
          <div className="section-divider" />

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div className="card--elevated text-center transition-transform duration-300 hover:shadow-xl">
      ...
      <section className="section section--soft-beige">
        <div className="container mx-auto px-4">
          <h2 className="section-heading text-center mb-6">Browse By Category</h2>
          <div className="section-divider" />
            ...
            {categoryLoading ? (
              ...
              categories && categories.map((category) => (
                <Link
                  ...
                  className="panel--grouped text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                >
      ...
      <section className="section section--soft-gray">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-6">
            <h2 className="section-heading">Our Farmers</h2>
            <Link
              to="/farmers"
              className="text-green-600 hover:text-green-800 font-medium text-lg transition-all duration-300"
            >
      ...
      <section className="section" aria-hidden="false">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link
              to="/register"
              className="btn bg-white text-green-600 hover:bg-gray-100 px-8 py-3 rounded-lg font-bold text-lg touch-target"
            >
              Sign Up Now
            </Link>
            <Link
              to="/about"
              className="btn border-2 border-white text-white hover:bg-white hover:text-green-600 px-8 py-3 rounded-lg font-bold text-lg touch-target"
            >
              Learn More
            </Link>
          </div>
